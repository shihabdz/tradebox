        ...
        <div class="card">
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="status" id="status" class="form-control basic-single">
                            ...
                            <option value="3"><?php echo display('success'); ?></option>
                            <option value="4"><?php echo display('canceled'); ?></option>
                        </select>
                    </div> 
                    <div class="col-md-2">
                        <button class="btn btn-lg btn-success" id="submitDeposit"><?php echo display('search'); ?></button>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="depositreportajaxtable" class="table table-bordered table-hover">
                        <thead>
                            <tr> 
...
<script src="<?php echo base_url("app/Modules/Report/Assets/Admin/js/custom.js?v=1.0") ?>" type="text/javascript"></script>