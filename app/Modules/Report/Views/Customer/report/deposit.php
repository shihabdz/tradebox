                   ...
                   <div class="table-responsive">
                        ...
                        <thead>
                            <tr> 
                                ...
                                <th width="15%"><?php echo display('payment_method') ?></th>
                                <th width="15%"><?php echo display('currency') ?>/<?php echo display('coin') ?></th>
                                <th width="15%" class="text-right"><?php echo display('amount') ?></th>
