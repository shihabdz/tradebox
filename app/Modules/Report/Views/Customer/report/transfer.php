        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row  align-items-end mb-4">
                    <div class="col-sm-12 content-title"><h4><?php echo display('transfer') ?> <?php echo display('report') ?></h4></div>
                   <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <button class="btn btn-lg btn-success" id="submitTransfer"><?php echo display('search'); ?></button>
                    </div>
                </div>
                <!-- /.end of alert message -->
                <div class="table-responsive">
                   <div class="table-responsive">
                    <table id="transferreportajaxtablehome" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th><?php echo display('sl_no') ?></th>
                                <th><?php echo display('date') ?></th>
                                <th><?php echo display('receiver'); ?></th>
