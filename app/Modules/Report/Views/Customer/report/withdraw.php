        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row align-items-end mb-4">
                    <div class="col-sm-12 content-title"><h4><?php echo display('withdraw') ?> <?php echo display('report') ?></h4></div>
                   <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <button class="btn btn-lg btn-success" id="submitWithdraw"><?php echo display('search'); ?></button>
                    </div>
                </div>
                <!-- /.end of alert message -->
                <div class="table-responsive">
                   <div class="table-responsive">
                    <table id="withdrawreportajaxtablehome" class="table table-bordered table-hover">
                        <thead>
                            <tr>
