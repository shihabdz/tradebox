            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                        <div class="col-form-label col-sm-4">
                            <label class="col-form-label "><?php echo display('callback_url'); ?></label>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="form-group row">
                        ...
                        <div class='col-sm-2'>
                               <a href='https://www.paystack.com' target='_blank'><?php echo display('create_account'); ?></a>
                        </div>
                </div>
                <div class="form-group row">
                       ...
                       <div class="form-group row">
                        <label for="shop_id" class="col-sm-4 col-form-label"><?php echo display('api_key'); ?><i class="text-danger">*</i></label>
                        <div class="col-sm-6">
                            <input name="secret_key" value="<?php echo esc($payment_gateway->secret_key) ?>" class="form-control" type="text" id="shop_id" required>
                        </div>
                        <div class='col-sm-2'>
                            <a href='https://www.currencyconverterapi.com/' target='_blank'><?php echo display('get_api_key'); ?></a>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="shop_id" class="col-sm-4 col-form-label"><?php echo display('mode'); ?></label>
                        <div class="col-sm-6">
                            <label class="radio-inline">
                                <?php echo form_radio('shop_id', 'free', (($payment_gateway->shop_id=='free' || $payment_gateway->shop_id==null)?true:false)); ?><?php echo display('free'); ?>
                             </label>
                            <label class="radio-inline">
                                <?php echo form_radio('shop_id', 'premium', (($payment_gateway->shop_id=="premium")?true:false) ); ?><?php echo display('premium'); ?>
                             </label> 
                        </div>
                    </div>
                        <div class="form-group row">
