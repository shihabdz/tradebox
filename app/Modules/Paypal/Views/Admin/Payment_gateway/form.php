        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                        ...
                        <div class='col-sm-2'>
                               <a href='https://www.paypal.com' target='_blank'><?php echo display('create_account'); ?></a>
                        </div>
                </div>
                <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="secret_key" class="col-sm-4 col-form-label"><?php echo display('mode'); ?></label>
                            <div class="col-sm-6 mt-2">
                                <label class="radio-inline">
                                    <?php echo form_radio('secret_key', 'sandbox', (($payment_gateway->secret_key=='sandbox' || $payment_gateway->secret_key==null)?true:false)); ?><?php echo display('Sandbox') ?>
                                 </label>
                                <label class="radio-inline">
                                    <?php echo form_radio('secret_key', 'live', (($payment_gateway->secret_key=="live")?true:false) ); ?><?php echo display('live') ?>
                                 </label> 
                            </div>
                        </div>
                        <div class="form-group row">
