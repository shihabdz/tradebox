...
$routes->group('backend', ['filter' => 'admin_filter', 'namespace' => 'App\Modules\Setting\Controllers\Admin'], function ($subroutes) {
    ...
    $subroutes->add('setting/export_phrase/(:any)', 'SettingController::exportPhrase/$1');
    $subroutes->post('setting/import_phrase/(:any)', 'SettingController::importPhrase/$1');
    ...
    $subroutes->add('setting/delete-phrase/(:any)', 'SettingController::deletePhrase/$1');
