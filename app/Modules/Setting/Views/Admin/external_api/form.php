        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <?php echo form_open_multipart("backend/setting/update-external-api/$apis->id") ?>
                    ...
                    ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input readonly="readonly" name="name" value="<?php echo esc($apis->name) ?>" class="form-control" type="text" id="name" required>
                            </div>
                            <div class='col-sm-4'>
                                <a href='<?php echo @$api_data['create_link']?>' target='_blank'><?php echo display('get_your_API_key');?> </a>
                            </div>
                        </div>
                        <div class="form-group row">
