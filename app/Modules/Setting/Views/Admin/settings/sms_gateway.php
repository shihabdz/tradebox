    ...
    <div class="col-sm-6 col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <?php echo form_open_multipart("backend/setting/update-sms-gateway") ?>
                        <?php echo form_hidden('es_id',$sms->es_id) ?>
                        <div class="form-group row">
                            <label for="gatewayname" class="col-sm-3 col-form-label font-weight-600"><?php echo display("gateway") ;?> <i class="text-danger">*</i></label>
                            <div class="col-sm-9">
                                <select class="form-control basic-single" name="gatewayname" id="gatewayname" required>
                                    ...
                                    <option value="twilio" <?php echo (esc($sms->gatewayname)=="twilio")?'Selected':'' ?>>Twilio</option>
                                </select>
                            </div>
                        </div>                        
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <br>
                                <br>
                                <p>For SMS Gateway Use  <a href="https://www.budgetsms.net" target="_blank"><b>budgetsms</b></a>/<a href="https://www.infobip.com" target="_blank"><b>infobip</b></a>/<a href="https://www.nexmo.com" target="_blank"><b>nexmo</b></a>/<a href="https://www.twilio.com" target="_blank"><b>twilio</b></a></p>
                            </div>
                        </div>
                        <?php echo form_close() ?>
                    </div>
    ...
    <div class="col-sm-6 col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12"> 
                        <?php echo form_open_multipart("backend/setting/test-sms") ?>
                        <div class="form-group row">
