    ...
    <div class="col-sm-6 col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12"> 
                        <?php echo form_open_multipart("backend/setting/update-email-gateway") ?>
    ...
    <div class="col-sm-6 col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12"> 
                        <?php echo form_open_multipart("backend/setting/email-test") ?>
                            <?php echo form_hidden('es_id',$email->es_id) ?>
                            <div class="form-group row">
                                <label for="email_to" class="col-sm-3 col-form-label font-weight-600"><?php echo display('to');?><i class="text-danger">*</i></label>
                                <div class="col-sm-9">
