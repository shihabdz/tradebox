    ...
    <?php echo form_open_multipart('backend/setting/security') ?>
        ...
        <div class="form-group row">
         ...
         <div class="form-group row">
            ...
            <label class="font-weight-600 col-sm-3  mt-4 text-right"><?php echo display('secret_key');?> <i class="text-danger">*</i></label>
            <div class="input-group col-sm-4 mt-4">
                <input type="text" name="secret_key" value="<?php echo esc($secret_key); ?>" placeholder="<?php echo display('secret_key');?>" class="form-control" id="secret_key" required>
                <div class="input-group-append">
