        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_hidden('article_id', @$article->article_id) ?> 
                    ...
                    <div class="form-group row">
                        <label for="headline_fr" class="col-sm-2 col-form-label font-weight-600"><?php echo display('headline_fr'); ?></label>
                        <div class="col-sm-10">
                            <input name="headline_fr" value="<?php echo strip_tags(@$article->headline_fr) ?>" class="form-control" placeholder="<?php echo display('headline_fr')." ".esc($web_language->name) ?>" type="text" id="headline_fr">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="pdflink" class="col-sm-2 col-form-label font-weight-600"></label>                     
                        <div class="col-sm-10">
                            <label class="checkbox-inline">                                
                              <?php if (@$article->pdflink == 1) { ?>
                                <input type="checkbox" id="pdflink" name="pdflink" value="Yes" checked > &nbsp; <?php echo display('link_with_pdf');?>
                                <?php } else { ?>
                                 <input type="checkbox" id="pdflink" name="pdflink" value="Yes"> &nbsp; <?php echo display('link_with_pdf');?>
                                <?php } ?>
                           </label>                         
                        </div>
                   </div>
                   <div class="form-group row">
                        <label for="article_pdf" class="col-sm-2 col-form-label font-weight-600"><?php echo display('upload_pdf') ?></label>
                        <div class="col-sm-10">
                            <input name="article_pdf" class="form-control" placeholder="<?php echo display('upload_pdf') ?>" type="file" id="article_pdf">
                             <input type="hidden" name="article_pdf_old" value="<?php echo @$article->article_pdf ?>">
                             <br/><?php if (@$article->article_pdf != NULL) { 
                                echo @$article->article_pdf; } ?><br/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="pageHeight" class="col-sm-2 col-form-label font-weight-600"><?php echo display('page_height');?></label>
                        <div class="col-sm-10">
                            <input name="pageHeight" value="<?php echo strip_tags(@$article->pageHeight) ?>" class="form-control" placeholder="<?php echo display('page_height'); ?>" type="text" id="pageHeight">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="article1_fr" class="col-sm-2 col-form-label font-weight-600"><?php echo display('article_fr')." ".esc($web_language->name) ?></label>
                        <div class="col-sm-10">
                            <textarea   id="ckeditor2" name="article1_fr" class="form-control" placeholder="<?php echo display('article_fr')." ".$web_language->name ?>" type="text" id="article1_fr"><?php echo @$article->article1_fr ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="article2_fr" class="col-sm-2 col-form-label font-weight-600"><?php echo display('article_fr')." ".esc($web_language->name) ?></label>
                        <div class="col-sm-10">
                            <textarea   id="ckeditor4" name="article2_fr" class="form-control" placeholder="<?php echo display('article_fr')." ".$web_language->name ?>" type="text" id="article2_fr"><?php echo @$article->article2_fr ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
