    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php echo form_open_multipart(base_url("backend/cms/add-notice/$article->article_id")); ?>
                <?php echo form_hidden('article_id', $article->article_id) ?> 
                   
                    <div class="form-group row">
                        <label for="article1_en" class="col-sm-2 font-weight-600"><?php echo display('notice') ?> En<i class="text-danger">*</i></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="article1_fr" class="col-sm-2 font-weight-600"><?php echo display('notice') ?> Fr</label>
                        <div class="col-sm-10">
                            <textarea name="article1_fr" class="form-control" placeholder="<?php echo display('answer')." " ?>" type="text" id="ckeditor2"><?php echo htmlspecialchars($article->article1_fr) ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
