            ...
            <div class="card-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="border_preview">
                        <?php echo form_open_multipart(base_url("backend/cms/add-category/$category->cat_id")) ?>
                        ...
                        <div class="form-group row">
                            <label for="cat_name_fr" class="col-sm-4 font-weight-600"><?php echo display('cat_name_fr');?></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <span class="text-danger">1200 x 600px (png,jpg,gif,ico)</span><br>
                                <?php if (!empty($category->cat_image)) { ?>
                                    <img src="<?php echo IMAGEPATH.$category->cat_image ?>" width="150">
                                <?php } ?>                            
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="cat_title1_fr" class="col-sm-4 font-weight-600"><?php echo display('cat_title_fr'); ?></label>
                            <div class="col-sm-8">
                                <input name="cat_title1_fr" value="<?php echo esc($category->cat_title1_fr) ?>" class="form-control" placeholder="<?php echo display('cat_title_fr'); ?>" type="text" id="cat_title1_fr">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="cat_title2_fr" class="col-sm-4 font-weight-600"><?php echo display('cat_title_fr');?></label>
                            <div class="col-sm-8">
                                <input name="cat_title2_fr" value="<?php echo esc($category->cat_title2_fr) ?>" class="form-control" placeholder="<?php echo display('cat_title_fr'); ?>" type="text" id="cat_title2_fr">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="position_serial" class="col-sm-4 font-weight-600"><?php echo display('position_serial'); ?></label>
                            <div class="col-sm-8">
                                <input name="position_serial" id="position_serial" value="<?php echo esc($category->position_serial) ?>" class="form-control" placeholder="<?php echo display('position_serial'); ?>" type="text" id="position_serial">
                            </div>
                        </div>
                        <div class="form-group row">
