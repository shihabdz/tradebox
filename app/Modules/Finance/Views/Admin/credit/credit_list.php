                ...
                <table id="example" class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo esc($value->amount).' '.esc($value->currency_symbol) ;?> </td>
                            <td><?php echo esc($value->comment);?></td>
                            <td class="text-center">
                                <a class="btn btn-success" href="<?php echo base_url()?>/backend/finance/credit-details/<?php echo esc($value->id);?>"><?php echo display('view');?></a>
                            </td>
                        </tr>
                        <?php } } ?>
                    </tbody>
