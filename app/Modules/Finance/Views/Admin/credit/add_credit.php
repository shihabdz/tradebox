<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body"> 
                <?php echo form_open('backend/finance/add-credit','class="form-inner"') ?>
                    ...
                    <div class="form-group row">
                        <label for="crypto_coin" class="col-sm-3 col-form-label font-weight-600"><?php echo display('coin') ?> <i class="text-danger">*</i></label>
                        <div class="col-sm-7">
                            <select class="form-control basic-single" name="crypto_coin" id="crypto_coin">
                                ...
                                <?php foreach ($coin_list as $key => $value) {  ?>
                                 <option value="<?php echo esc($value->symbol); ?>"><?php echo esc($value->full_name)." (". esc($value->symbol). ")";; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
