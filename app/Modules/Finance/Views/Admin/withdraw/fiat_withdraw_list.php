          ...
          <table id="example" class="table display table-bordered table-striped table-hover">
              <thead>
                  <tr>
                      ...
                      <th width="60"><?php echo display('name') ?></th>
                      ...
                      <th class="text-center" width="180"><?php echo display('action') ?></th>
                  </tr>
              </thead>
              <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                          ...
                          <?php if($value->status == 2){?>
                           ...
                           <span class="text-success"><?php echo display('success')?></span> 
                           <?php } else if($value->status == 0){ ?>
                           <span class="text-danger"><?php echo display('cancel')?></span> 
                            <?php } else if($value->status==3){ ?>
                             <div class="progress">
                                  <div title="<?php echo display('processing');?>" class="progress-bar progress-bar-striped bg-success progress-bar-animated width85" role="progressbar" aria-valuenow="98" aria-valuemin="0" aria-valuemax="100"> <?php echo display('processing');?> 
                                  </div>
                                </div>
                            <?php } ?>
                       </td>
