    ...
    <div class="card-body">
        ...
        <?php echo form_hidden('user_id', $user->user_id) ?>
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <label class="font-weight-600" for="status"><?php echo display("status") ?> <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
...
<script src="<?php echo BASESEURL.'app/Modules/User/Assets/js/script.js' ;?>"></script>
