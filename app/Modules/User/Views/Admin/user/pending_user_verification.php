                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 card-body">
                	...
                	<div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <?php if ($user->verified == 1 || $user->verified == 4 || $user->verified == 7 || $user->verified == 8) { echo "Verified"; } ?>
                            <?php if ($user->verified == 2 || $user->verified == 10 || $user->verified == 11 || $user->verified == 15) { echo "Cancel"; } ?>
                            <?php if ($user->verified == 3 || $user->verified == 13 || $user->verified == 12 || $user->verified == 14) { echo "Processing"; } ?>
                            </h5>
                        </div>
                    </div>

                    <?php if ($user->verified==3 || $user->verified==12 || $user->verified==13 || $user->verified==14) { ?>
					<div>
