                    ...
                    <table id="example" class="table table-bordered table-hover">
                        <thead>
                            <tr class="table-bg">
                                ...
                                <th class="text-right"><?php echo display('available_qty');?></th>
                                <th class="text-right"><?php echo display('required');?> <?php echo display('amount');?></th>
                                <th class="text-right"><?php echo display('available_amount');?></th>
                                <th><?php echo display('market');?></th>
                                <th><?php echo display('date');?></th>
                                <th class="hide text-right"><?php echo display('complete');?> <?php echo display('quantity');?></th>
                                <th class="hide text-right"><?php echo display('complete');?> <?php echo display('amount');?></th>
