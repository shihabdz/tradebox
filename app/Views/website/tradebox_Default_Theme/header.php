<?php 
    ...
    if ($home_menu) {
        ...
        $menu_cls ='navbar-dark bg-kingfisher-daisy sticky-top';   
                     
    } else {

        $menu_cls = 'navbar-dark bg-kingfisher-daisy sticky-top';  // 'bg-transparent';
    }
...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" type="image/png" href="<?php echo IMAGEPATH.$settings->favicon; ?>">
        ...
        <script type="text/javascript">
             ...
             var langusge = '<?php echo $session->get('lang') != NULL ? $session->get('lang'):$settings->language;?>';
        </script>
 ...
 <?php $showmenue = false; if($settings->show_trademenu_without_verify == 1) { 
       $showmenue = true;
  } else {
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <?php  if($session->get('user_id') != NULL){ ?>
                            ...
                            <ul class="pull-right">
                                <li class="nav-item dropdown">
                                     <a class="f_profile dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#"><span class ="f_name"><?php //echo esc($userinfo->first_name." ".$userinfo->last_name) ?></span>
