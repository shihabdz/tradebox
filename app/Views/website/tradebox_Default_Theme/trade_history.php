                    ...
                    <table class="table table-responsive">
                        <thead>
                            <tr class="table-bg">
                                ...
                                <th class="text-right" title="<?php echo display('required_qty') ?>"><?php echo display('required_qty') ?></th>
                                <th class="text-right" title="<?php echo display('available_qty') ?>"><?php echo display('available_qty') ?></th>
                        ...
                        <tbody id="usertradeHistory">
                            <?php  foreach ($user_trade_history as $key => $value) { ?>
                            	<tr>
                            		...
                            		<td class="text-center"><?php echo esc($value->status) == 0 ? "<i title='".display('canceled')."' class='far fa-times-circle'></i>" : (esc($value->status) == 1 ? "<i title='Complete' class='fas fa-check-circle'></i>" : '<div class="progress"><div title="'.display("running").'" class="progress-bar progress-bar-striped width100percent">'.display("running").'</div></div>') ?></td>
                            	</tr>
                            <?php } ?>
                        </tbody>
                    </table>
