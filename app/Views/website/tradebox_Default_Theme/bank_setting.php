                    ...
                    <!-- /.alert message -->
                        <div class="mb-4 form-design">  
                            ...
                            <?php echo form_open('bank-setting/bank');?>
                                ...
                                <div class="form-group row">
                                    <label for="bank_address" class="col-md-4 col-form-label"><?php echo display('bank_address') ?><i class="text-danger">*</i></label>
                                    <div class="col-md-8">
                                        <input name="bank_address" type="text" class="form-control" id="bank_address" value="<?php echo esc(@$branch_name); ?>" required>
                                    </div>
                                </div>
