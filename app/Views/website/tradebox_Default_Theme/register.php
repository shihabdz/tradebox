            ...
            <?php echo form_open('register','id="registerForm" name="registerForm" onsubmit="return validateForm()" '); ?>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="f_name"><?php echo display('f_name') ?> <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="f_name" name="f_name" placeholder="First Name">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="l_name"><?php echo display('l_name') ?> <span class="text-danger">*</span></label>
                ...
                <div class="form-row password_valid">
                    ...
                    <div id="message">
                      <p class="text-danger mt-20"> Password must include the following:</p>
                ...
                <div class="d-flex justify-content-between mb-3">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="accept_terms"> <?php echo display('tearms_conditions_text'); ?></label>
                    </div>
                </div> 
                <div class="d-flex justify-content-between mb-3">
                    <p class="text-white"> <?php echo display('your_password_at_global_crypto_are_encrypted_and_secured'); ?></p>
