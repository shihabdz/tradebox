                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slide-text text-center">
                                    ...
                                    <?php if(!empty($value->slider_h3_en)  || !empty($value->slider_h3_fr)) { ?>
...
<div class="about pt-5 pb-5">
    <div class="container">
           <div class="row">
               <div class="col-md-10 offset-md-1 text-center about-text pt-3 pb-2"> 
                <?php $headline     =   isset($lang) && $lang =="french"?$welcome->headline_fr:$welcome->headline_en;
                      $article1     =   isset($lang) && $lang =="french"?$welcome->article1_fr:$welcome->article1_en;?>
                     <h3 class="title mb-2"> <?php echo $headline ;?></h3>
                     <?php echo $article1 ;?>
                </div>
            </div>
    </div>
...
<div class="price-spike">
    <div class="container">
        ...
        <div class="row"><div class="col-md-12 text-center">  <a href="<?php echo base_url('coin-list');?>" class="btn btn-info btn-lg"> Show more </a></div></div>
    </div>
</div>
<!--  ./End of price spike -->
