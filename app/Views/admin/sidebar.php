      ...
      <div class="sidebar-body">
         <nav class="sidebar-nav">
            <ul class="metismenu">
               ...
               <li>
                  <a target="_blank" href="https://www.youtube.com/watch?v=HHwgLq5f1_Q&list=PLth9eDNSX3Ejfm-TBwT0Z3u1XFJIOwlcs&index=9"><i class="fas fa-file-video"></i><?php echo display('tutorial');?></a>
               </li>
               <li>
                  <a target="_blank" href="https://www.bdtask.com/contact.php"><i class="fa fa-question-circle"></i><?php echo display('support');?></a>
               </li>
            </ul>
         </nav>
      </div>
